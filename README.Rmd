...
**Based on this package, the [`rolap`](https://CRAN.R-project.org/package=rolap) package has been developed, which incorporates the main functionalities for which `starschemar` was initially intended, with the aim of facilitating its maintenance and evolution.**
