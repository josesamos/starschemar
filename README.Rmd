...
**Based on this package, the [`rolap`](https://CRAN.R-project.org/package=rolap) package has been developed. It incorporates the main functionalities for which `starschemar` was initially intended, it has a new data model defined with the aim of facilitating its maintenance and evolution.**
