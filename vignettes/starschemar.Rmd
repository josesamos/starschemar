...
From the result in the form of a flat table, [`pivottabler`](https://cran.r-project.org/web/packages/pivottabler) package can be used to present it in the form of a pivot table.
...
1. Finally, basic queries can be performed from R  (*query functions*).
