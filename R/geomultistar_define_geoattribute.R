...
#'
#' Associates the instances of an attribute of the geographic dimension with the
#' instances of a geographic layer or defines it from the geometry of another
#' previously defined geographic attribute.
#'
